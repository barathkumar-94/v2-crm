...
import { ppabasedFinalbillHelp } from './ppabasedFinalbillHelp';
 
 
const actionInputs = ['bill','billdate','status','financialyear','billingperiod','generationperiod',
'status','billcategory','billtype','remarks','PPA_No','title','customercode','customername',
...
const helpComponents = {
  ppabasedFinalbillHelp: ppabasedFinalbillHelp,
...
const actionBarButtons: IControlDefinition[] = [
    {
      ...
      label: 'Return',
      event: {
        serviceName: 'RCRM_RETURN_DIRECTPPA_BILL',
        moduleName: CRM_BILLING,
        input: [...actionInputs],
      },
    },

    {
      ...
      label: 'Authorize',
      event: {
        serviceName: 'RCRM_AUTHORIZE_DIRECTPPA_BILL',
        moduleName: CRM_BILLING,
        input: [...actionInputs],
      },
    },
    {
      ...
      label: 'Cancel',
      event: {
        serviceName: 'RCRM_CANCEL_DIRECTPPA_BILL',
        moduleName: CRM_BILLING,
        input: [...actionInputs],
      },
    },
    {
      ...
      event: {
        getEventProps:(pageData)=>{
          return{
        serviceName: 'RCRM_PRINT_PPABASED_FINALBILL',
        moduleName: CRM_BILLING,
        input: [...actionInputs],
        downloadFile:{
...
const onLoadEventParams: IRFEventParams = {
  serviceName:'RCRM_INIT_FINAL_MANAGE_BILL',
  moduleName: CRM_BILLING,
    input: ['bill'] 
};
 
export const FinalManageBill:React.FC<IPageBaseProps> = (props) => {
  ...
  return (
   ...
   {({values})=>(	
    ...
    <ScrollabeContainer hasHeader={true}>
      ...
      <RFSection  controls={DiscomTariff} title={'DISCOM Charges'} columns={1} className={'section-header-bg-primary'} collapse={false}/>
