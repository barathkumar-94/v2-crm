...
const searchSection: IControlDefinition[] = [
  ...
  
  {
    ...
    label: 'Print',
    event: {
      serviceName: 'RCRM_PRINT_SOLAR_SHARE',
      moduleName: CRM_BILLING,
      input: [...searchInputs],
      downloadFile:{
        jasperReportTemplate: 'SolarElectricalShareReport',
        fileName:'SolarReport.pdf',
        input : ['guid']
      }
    },
  },
...
const onLoadEventParams: IRFEventParams = {
  serviceName: 'RCRM_INIT_SOLAR_SHARE',
  moduleName: CRM_BILLING,
  input: ['id']
};

export const SolarElectricalShareReport: React.FC<IPageBaseProps> = (props) => {
