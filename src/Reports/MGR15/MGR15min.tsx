...
const searchInputs = ['generationyear','generationperiod','site', 'assetid', 'meterid'];
const searchSection: IControlDefinition[] = [
  ...
  
  {
    ...
    label: 'Print',
    event: {
      serviceName: 'RCRM_PRINT_MGR_REPORT',
      moduleName: CRM_BILLING,
      input: [...searchInputs],
      downloadFile:{
        jasperReportTemplate: 'MGR15Block',
        fileName:'MGR15min.pdf',
        input : ['guid']
      }
    },
  },
...
const onLoadEventParams: IRFEventParams = {
  serviceName: 'RCRM_INIT_MGR15_REPORT',
  moduleName: CRM_BILLING,
  input: ['id']
};

export const MGR15min: React.FC<IPageBaseProps> = (props) => {
