...
const searchInputs = ['generation_year','generation_period', 'date','customer_name','htsc','Status','consumerEnergyDataGrid'];
...
const searchSection: IControlDefinition[] = [
  ...
  
  {
    ...
    event: {
      ...
      serviceName: 'RCRM_SEARCH_ENERGY_SUM',
      input: searchInputs,
    },
  },
];
    ...
    columns: [
      {
        ...
        cellRendererParams: {
          event: {
            linkTo: '/ManageEnergyDemandPlanning',
...
export const ConsumerDemandPlanningSummary:React.FC<IPageBaseProps> = (props) => {
  return (
