...
import { JMREntryHelp } from './JMREntryHelp';
...
const actionInputs =[
  'id','date','site','meterid','metertype','assetid','assetname','status','takenby','notes','generationPeriod'
...
,'currentreadingExp_kvarh','netreadingExp_kvarh','powerfactorExp_kvarh','voltageExp_kvarh',
'lastreadingImp_kwh','lastreadingdateImp_kwh','lastreadingtimeImp_kwh','currentreadingImp_kwh','netreadingImp_kwh','powerfactorImp_kwh','voltageImp_kwh',
'jmrAttachmentGrid',
'jmrExportGrid','jmrImportGrid','generationyear','SEQ_NO_EXP',
'lastreadingImp_kvarh','lastreadingdateImp_kvarh','lastreadingtimeImp_kvarh','currentreadingImp_kvarh','netreadingImp_kvarh','powerfactorImp_kvarh','voltageImp_kvarh',
'customerCreditData','assettype'];
 
    const onEnterEvent: IRFEventParams = {
        input: ['id'],
        moduleName: CRM_ENERGY_ACCOUNTING,
        serviceName: 'RCRM_ONENTER_JMR_ENTRY_MST',
      };
     
      const helpComponents = {
        JMREntryHelp:JMREntryHelp
      };
...
const generalSection: IControlDefinition[] = [
    {
        ...
        event: onEnterEvent,
    help: {
      panelTitle: 'Help On JMR Entry',
      componentName: 'JMREntryHelp',
  ...
  
  {
    ...
    required:true,
    event :{
      serviceName:'RCRM_JMRENTRY_ONCHANGE_SITE',
      moduleName :CRM_ENERGY_ACCOUNTING,
      input:['site']
      }
  },
  {
    ...
    required:true,
    event :{
      serviceName:'RCRM_JMRENTRY_ONCHANGE_ASSET',
      moduleName :CRM_ENERGY_ACCOUNTING,
      input:['assetid']
      }
  },
  ...
  },
  {
    ...
    required:true,
    event :{
      serviceName:'RCRM_JMRENTRY_ONCHANGE_METER',
      moduleName :CRM_ENERGY_ACCOUNTING,
  ...
  },
  {
    ...
    event :{
      serviceName:'RCRM_JMRENTRY_GENERATION_YEAR_ONCHANGE',
      moduleName :CRM_ENERGY_ACCOUNTING,
 ...
 
  {
    ...
    required:true,
    event :{
      serviceName:'RCRM_JMRENTRY_GENERATIONPERIOD_ONCHANGE',
      moduleName :CRM_ENERGY_ACCOUNTING,
      input:['generationPeriod','metertype','assetid','site','meterid']
      }
  },
...
const ImportReadingKWHSection: IControlDefinition[] = [
  ...
  },
  {
    ...
    label: 'Last Reading (Lag)',
  },
  {
    type: ControlType.DISPLAY,
    name: 'lastreadingdateImp_kwh',
    label: 'Last Reading Date',
    format:DATE_FORMAT
  },
  {
...
const actionBarButtons: IControlDefinition[] = [
 ...
 
    {
        ...
        label: 'Create',
        event: {
          serviceName: 'RCRM_CREATE_JMR_ENTRY_MST',
          moduleName: CRM_ENERGY_ACCOUNTING,
          input: [...actionInputs],
        },
      },
      {
        ...
        label: 'Save',
        event: {
          serviceName: 'RCRM_SAVE_JMR_ENTRY_MST',
          moduleName: CRM_ENERGY_ACCOUNTING,
          input: [...actionInputs],
        },
      },
      {
        ...
        label: 'Submit',
        event: {
          serviceName: 'RCRM_SUBMIT_JMR_ENTRY_MST',
          moduleName: CRM_ENERGY_ACCOUNTING,
          input: [...actionInputs],
        },
      },
...
const onLoadEventParams: IRFEventParams = {
 serviceName: 'RCRM_INIT_JMR_ENTRY_MST',
  moduleName: CRM_ENERGY_ACCOUNTING,
  input: ['id']
};
 
export const ManageJMREntry:React.FC<IPageBaseProps> = (props) => {
  ...
  return (
    <RetinaFormBuilder initialValues={initialData}  scrollKey={props.scrollKey}  onLoadEventParams={onLoadEventParams} components={helpComponents} className={'page-with-footer-btn-meta'} prompt>
      ...
      <ScrollabeContainer hasHeader={true}>
        ...
        <RFSection  controls={MonthlySection} title={'Summary'} columns={6} className={'section-header-bg-primary'} collapse={false}/>
        <RFTabs>
