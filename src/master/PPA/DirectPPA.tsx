...
import { DirectPPAHelp } from './DirectPPAHelp';
...
'Equity_Investment','Min_Consumption_Limit','uom_term_detail', 'Total_Equity_Share','Total_Equity_Share_of_Consumers',
...
'ConsumerSummary','OpenAccessCharges','DISCOMTarifTODsummary','DISCOMTarifTCDsummary','mw_share',
'notes','attachmentsummary','SelectTemplate','OpportunityCodeHdn','PayTermHdn','approvalNotes','fileName','fileReference','templatePreview','Shareholdig_in_company_per',
...
const OpportunityDetailsSection: IControlDefinition[] = [
  ...
  help: {
    ...
    componentName: 'PPAOpportunityHelp',
...
export const DirectPPA:React.FC<IPageBaseProps> = (props) => {
