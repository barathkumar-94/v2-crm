...
import { PPAServiceHelp } from '../PPA/PPAServiceHelp';
import { PPATariffHelp } from '../PPA/PPATariffHelp';
import { LOIPayTermHelp } from '../LOIMaster/LOIPayTermHelp';


const actionInputs = ['PPA_No','PPA_Date','Amendment','Title','PPA_Status','PPA_value',
...
export const ManagePPAAmendment:React.FC<IPageBaseProps> = (props) => {
