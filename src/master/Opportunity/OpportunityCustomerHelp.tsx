...
const searchSection: IControlDefinition[] = [
  ...
  },
  {
    ...
    event: {
      ...
      serviceName: 'RCRM_OPPORTUNITY_CUSTOMER_ACCOUNT_SEARCH_SUM',
      input: searchInputs,
    },
  },
];
...
const onLoadEventParams: IRFEventParams = {
   serviceName: 'RCRM_OPPORTUNITY_CUSTOMER_ACCOUNT_INIT_SUM',
  moduleName: CRM_MASTER,
};

export const OpportunityCustomerAccountHelp:React.FC<IPageBaseProps> = (props) => {
  return (
