...
const searchSection: IControlDefinition[] = [
  ...
  },
  {
    ...
    event: {
      ...
      serviceName: 'RCRM_OPPORTUNITY_DIRECT_SEARCH_SUM',
      input: searchInputs,
    },
  },
];
...
const onLoadEventParams: IRFEventParams = {
   serviceName: 'RCRM_OPPORTUNITY_DIRECT_INIT_SUM',
  moduleName: CRM_TRANSACTION,
  input: searchInputs
};
export const DirectOpportunityHelp:React.FC<{Site:string}> = (props) => {
