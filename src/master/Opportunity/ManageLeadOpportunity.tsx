...
import { opportunityLeadHelp } from './OpportunitylLeadHelp';
...
const actionInputs = ['opportunitycode','lead_code','lead_description','opportunitydescription','opportunitystatus','industry',
...
const onEnterEvent: IRFEventParams = {
  input: ['opportunitycode','lead_code'],
  moduleName: CRM_TRANSACTION,
  serviceName: 'RCRM_LEAD_OPPORTUNIYT_ONENTER_MST',
};

const helpComponents = {
  opportunityLeadHelp: opportunityLeadHelp,
...
const detailsSection: IControlDefinition[] = [
    ...
    help: {
      ...
      componentName: 'opportunityLeadHelp',
  ...
  },
  {
    ...
    label: 'Source Name',
    hidden:true,
    //hidden: (pageData)=>pageData.opportunitysource == 'CC' || pageData.opportunitysource == 'DE',
  },
...
const actionBarButtons: IControlDefinition[] = [
  {
    ...
    label: 'Create',
    event: {
      serviceName: 'RCRM_LEAD_OPP_CREATE_MST',
      moduleName: CRM_TRANSACTION,
      input: [...actionInputs],
    },
  },
...
const onLoadEventParams: IRFEventParams = {
  serviceName: 'RCRM_LEAD_OPPORTUNITY_INIT',
  moduleName: CRM_TRANSACTION,
    input: ['lead_code','opportunitycode']
};

export const ManageLeadOpportunity:React.FC<IPageBaseProps> = (props) => {
